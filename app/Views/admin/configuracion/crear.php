                    ...
                    <form action="<?= base_url('admin/configuracion/guardar') ?>" method="post">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-text">Identificador único de la configuración (ej: nombre_restaurante)</div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="valor" name="valor" rows="3" required><?= old('valor') ?></textarea>
